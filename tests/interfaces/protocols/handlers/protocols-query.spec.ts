...
describe('handleProtocolsQuery()', () => {
    describe('functional tests', () => {
        ...
        it('should return protocols matching the query', async () => {
            ...
            const message1Data = await TestDataGenerator.generateProtocolsConfigureMessage({
                requester: alice,
                target: alice,
            })
            const message2Data = await TestDataGenerator.generateProtocolsConfigureMessage({
                requester: alice,
                target: alice,
            })
            const message3Data = await TestDataGenerator.generateProtocolsConfigureMessage({
                requester: alice,
                target: alice,
            })
        ...
        it('should return 401 if auth fails', async () => {
            ...
            const messageData = await TestDataGenerator.generateProtocolsQueryMessage({
                requester: alice,
                target: alice,
            })
