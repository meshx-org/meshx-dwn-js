...
export abstract class Message {
    ...
    /**
     * @returns message with the largest CID in the array using lexicographical compare.
     * `undefined` if given array is empty.
     */
    ...
    /**
     * Signs the provided message to be used an `authorization` property.
     * Signed payload includes the CID of the message's descriptor by default
